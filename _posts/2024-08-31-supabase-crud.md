...
이번에 글 작성 영역을 에디터 라이브러리를 사용하려 했는데, [Toast UI Editor](https://ui.toast.com/tui-editor/) 가 채택되었다. TUIEditor.jsx로 컴포넌트를 생성한 후 재사용 가능하게 설정해줬다. 아래는 적용 코드이며 주석을 작성하여 팀원이 사용하기 쉽게 정리했다.
